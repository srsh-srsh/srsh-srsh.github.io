<template>
  ...
  <ul class="timeline">
    ...
    <li class="timeline-item">
      ...
      <div class="bubble">
        <ul>
            ...
            <li>Participated in Hack(H)er Hackathon: built full-stack React/MongoDB app, won "Best Use of MongoDB Atlas."
            </li>
            <li>Briefly worked as a Web and Illustration Intern at Sciquel: created website assets and +5 illustrations with Bootstrap and Adobe Illustrator.
            </li>
        </ul>
      </div>
    </li>
    ...
    <li class="timeline-item">
      ...
      <div class="bubble">
        <ul>
            <li>Finished my Junior year at UMass Amherst, with a focus on Computer Science and Political Science.
            </li>
        </ul>
      </div>
    </li>
    ...
    <li class="timeline-item">
      ...
      <div class="bubble">
        <ul>
            <li>Was a Research Assistant at UMass Amherst: contributed to Renaissance art research and co-authored article.
            </li>
            <li>Policy Intern at New York State Senate: analyzed events and authored 12 memos to inform campaign strategies.
            </li>
        </ul>
      </div>
    </li>
    ...
    <li class="timeline-item">
      ...
      <div class="bubble">
        <ul>
            <li>Began role as Web and Graphic Designer at SiteSaga: designed WordPress prototypes, graphics, and SEO-optimized blog pages.
            </li>
            <li>Started Project Intern position at Glacier Systems Inc: created company website with Bootstrap, designed logos, managed social media campaigns.
            </li>
        </ul>
      </div>
    </li>
